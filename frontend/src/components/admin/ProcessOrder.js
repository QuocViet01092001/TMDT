...
import { getOrderDetails, updateOrder, clearErrors, getOrderDetailsId } from '../../actions/orderActions'
...
const ProcessOrder = ({ match }) => {
    ...
    useEffect(() => {
        ...
        dispatch(getOrderDetailsId(orderId))
                        ...
                        {loading ? <Loader /> : (
                            <div className="row d-flex justify-content-around">
                                <div className="col-12 col-lg-7 order-details">
                                    ...
                                    <p><b>Tổng tiền:</b> {formatCurrency(totalPrice)}</p>
