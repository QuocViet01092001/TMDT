                        ...
                        <div className="col-md-12">
                            <div className="card">
                                ...
                                <div className="card-body cart">
                                    <div className="col-sm-12 empty-cart-cls text-center"> <img src="/images/unnamed.jpg" width={130} height={130} className="img-fluid mb-4 mr-3" alt='' />
                                        <h3><strong>Chưa có sản phẩm nào trong giỏ hàng</strong></h3>
                                        <Link to="/" className="btn btn-primary cart-btn-transform m-3" data-abc="true">Quay lại cửa hàng</Link>
                                    </div>
                                </div>
                            </div>
                        </div>
                                            ...
                                            <div className="row">
                                                ...
                                                <div className="col-4 col-lg-1 mt-4 mt-lg-0">
                                                    <div className="delete">
                                                        <i class="bi bi-trash3-fill " onClick={() => removeCartItemHandler(item.product)} ></i>
                                                    </div>
                                                </div>
